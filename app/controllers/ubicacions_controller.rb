class UbicacionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ubicacion.save
        format.html { redirect_to @ubicacion, notice: 'Ubicacion se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @ubicacion.update(ubicacion_params)
        format.html { redirect_to @ubicacion, notice: 'Ubicacion se actualizo correctamente.' }
  ...
  def destroy
    @ubicacion.destroy
    respond_to do |format|
      format.html { redirect_to ubicacions_url, notice: 'Ubicacion se elimino correctamente.' }
  ...
  private
    ...
    def ubicacion_params
      params.require(:ubicacion).permit(:longitud, :latitud, :referencia, :ciudad_id)
    end
end
