class LugarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lugar.save
        format.html { redirect_to @lugar, notice: 'Lugar se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @lugar.update(lugar_params)
        format.html { redirect_to @lugar, notice: 'Lugar se actualizo correctamente.' }
  ...
  def destroy
    @lugar.destroy
    respond_to do |format|
      format.html { redirect_to lugars_url, notice: 'Lugar se elimino correctamente.' }
  ...
  private
    ...
    def lugar_params
      params.require(:lugar).permit(:nombre_lugar, :descripcion_lugar, :telefonos, :link, :tipo_lugar_id, :tipo_lugar_id, :ubicacion_id)
    end
end
