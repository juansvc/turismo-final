class ImagensController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @imagen.save
        format.html { redirect_to @imagen, notice: 'Imagen se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @imagen.update(imagen_params)
        format.html { redirect_to @imagen, notice: 'Imagen se actualizo correctamente.' }
  ...
  def destroy
    @imagen.destroy
    respond_to do |format|
      format.html { redirect_to imagens_url, notice: 'Imagen se elimino correctamente.' }
  ...
  private
    ...
    def imagen_params
      params.require(:imagen).permit(:nombre_imagen, :imagen, :descripcion_imagen, :lugar_id, :foto)
    end
end
