class CiudadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ciudad.save
        format.html { redirect_to @ciudad, notice: 'Ciudad se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @ciudad.update(ciudad_params)
        format.html { redirect_to @ciudad, notice: 'Ciudad se actualizo correctamente.' }
  ...
  def destroy
    @ciudad.destroy
    respond_to do |format|
      format.html { redirect_to ciudads_url, notice: 'Ciudad se elimino correctamente.' }
