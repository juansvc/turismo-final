class TransportesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @transporte.save
        format.html { redirect_to @transporte, notice: 'Transporte se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @transporte.update(transporte_params)
        format.html { redirect_to @transporte, notice: 'Transporte se actualizo correctamente.' }
  ...
  def destroy
    @transporte.destroy
    respond_to do |format|
      format.html { redirect_to transportes_url, notice: 'Transporte se elimino correctamente.' }
