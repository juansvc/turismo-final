class ActividadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @actividad.save
        format.html { redirect_to @actividad, notice: 'Actividad se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @actividad.update(actividad_params)
        format.html { redirect_to @actividad, notice: 'Actividad se actualizo correctamente.' }
  ...
  def destroy
    @actividad.destroy
    respond_to do |format|
      format.html { redirect_to actividads_url, notice: 'Actividad se elimino correctamente.' }
