...
class ImagensControllerTest < ActionController::TestCase
  ...
  test "should create imagen" do
    assert_difference('Imagen.count') do
      post :create, imagen: { descripcion_imagen: @imagen.descripcion_imagen, imagen: @imagen.imagen, lugar_id: @imagen.lugar_id, lugar_id: @imagen.lugar_id, nombre_imagen: @imagen.nombre_imagen }
    end
  ...
  test "should update imagen" do
    patch :update, id: @imagen, imagen: { descripcion_imagen: @imagen.descripcion_imagen, imagen: @imagen.imagen, lugar_id: @imagen.lugar_id, lugar_id: @imagen.lugar_id, nombre_imagen: @imagen.nombre_imagen }
    assert_redirected_to imagen_path(assigns(:imagen))
  end
