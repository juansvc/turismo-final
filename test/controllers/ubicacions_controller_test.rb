...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { ciudad_id: @ubicacion.ciudad_id, ciudad_id: @ubicacion.ciudad_id, latitud: @ubicacion.latitud, longitud: @ubicacion.longitud, referencia: @ubicacion.referencia }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { ciudad_id: @ubicacion.ciudad_id, ciudad_id: @ubicacion.ciudad_id, latitud: @ubicacion.latitud, longitud: @ubicacion.longitud, referencia: @ubicacion.referencia }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
