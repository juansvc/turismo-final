...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { comentario: @comentario.comentario, lugar_id: @comentario.lugar_id, lugar_id: @comentario.lugar_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { comentario: @comentario.comentario, lugar_id: @comentario.lugar_id, lugar_id: @comentario.lugar_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
